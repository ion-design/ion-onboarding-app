...
module.exports = {
  ...
  safelist: [
    ...
    {
      pattern: /^(?:bg|bg-on|text|text-on|border|border-on|fill|ring)-(?:primary|neutral|danger|info|warning|success)(?:|-stroke|-container|-accent|-pressed|-hover)$/,
      variants: ["hover", "ui-selected", "active"],
    },
    {
      pattern: /^(border)-(?:primary|neutral|danger|info|warning|success)(-stroke)$/,
      variants: ["hover", "ui-selected", "active"],
    },
    {
      pattern: /^(?:bg|bg-on|text|text-on|border|border-on|fill|ring)-(?:primary|neutral|danger)(?:|-sub|-container|-accent|-pressed|-hover)$/,
      variants: ["hover", "ui-selected", "active"],
    },
    {
      pattern: /^(?:bg|bg-on|text|text-on|border|border-on|fill|ring)-(?:primary|neutral|danger)(?:|-sub|-container|-accent|-pressed|-hover)$/,
